	...
	<div class="oneCard-right">
		...
		<div class="wulianBot">
			<div class="wulianBotBox">
				...
				<div class="roadBot">
					<div class="firstBox">
						<div class="firstBoxTop">站点总数</div>
						<div class="firstBoxBot">9548</div>
					</div>
					<div class="rightBox">
						<div class="otherBoxs1">
							<div style="color: white;">设备总数</div>
							<div class="otherBoxsBot">
								...
								<div class="otherBoxsBotBox">
									...
									<div class="otherWord">上线率</div>
								</div>
							</div>
						</div>
						<div class="otherBoxs2">
							<div style="color: white;">快充</div>
							<div class="otherBoxsBot">
								<div class="otherBoxsBotBox">
									<div class="otherNum">3430</div>
								...
								<div class="otherBoxsBotBox">
									<div class="otherNum">78%</div>
									<div class="otherWord">使用率</div>
								</div>
							</div>
						</div>
						<div class="otherBoxs3">
							<div style="color: white;">慢充</div>
							<div class="otherBoxsBot">
								<div class="otherBoxsBotBox">
									<div class="otherNum">3430</div>
									<div class="otherWord">空闲</div>
...
<style scoped="scoped">
	...
	.otherBoxs1 {
		...
		justify-content: space-around;
		align-items: center;
		background: url(../../assets/images/shebeilan.png) no-repeat;
	...
	.otherBoxs2 {
		...
		justify-content: space-around;
		align-items: center;
		background: url(../../assets/images/kuaichong.png) no-repeat;
		background-size:100% 100%;
	}
	...
	.otherBoxs3 {
		...
		justify-content: space-around;
		align-items: center;
		background: url(../../assets/images/chongdian.png) no-repeat;
		background-size:100% 100%;
	}
